...
var KTAppExpireToDayDatatable = function () {
    // variables
    var datatable;
    var heading;
    ...
    var init = function () {
        ...
        datatable = $('#datatable_list_expire_to_day').KTDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
                        method: 'POST',
                        headers: {},
                        url: laroute.route('admin.dashboard.get-list-service-expire-to-day'),
                        map: function(raw) {
                            // sample data mapping
                            var dataSet = raw;
...
KTUtil.ready(function () {
    KTAppExpireToDayDatatable.init();
});
