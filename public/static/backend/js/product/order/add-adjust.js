...
var orderAdjust = {
    ...
    getServices: function (t) {
        ...
        if (customer_id !== '') {
            $.ajax({
                url: laroute.route('product.get-list-service-by-customer'),
                method: 'POST',
                dataType: 'JSON',
                data: {
            ...
            success: function (res) {
                if (!res.error) {
                    ...
                    if (content != null && content != '') {
                        ...
                        var monthOrDay = ' Tháng';
                        if (res.serviceDetail.type == 'trial') {
                            monthOrDay = ' Ngày';
                        }
                        ...
                        tplInfoService = tplInfoService.replace(/{quantity}/g, res.serviceDetail.quantity + monthOrDay);
