...
@section('content')
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">@lang('wiki::wiki.index.suaknowledgebase')</h3>
        ...
        <div class="kt-subheader__toolbar">
            <div class="btn-group">
                <button type="submit" class="btn btn-primary" onclick="knowledgebase.edit(0)">
                    @lang('wiki::wiki.index.capnhat')
                </button>
{{--                <button type="submit" class="btn btn-primary" onclick="knowledgebase.edit(1)">--}}
            ...
            <div class="kt-portlet__body">
                        ...
                        <div class="col-10">
                            <select type="text" name="category_id" id="category_id" class="form-control --select2 ss--width-100">
                                @foreach($listCategory as $value)
                                    <option value="{{$value['id']}}" {{$value['id'] == $detail['category_id'] ? "selected" : ""}}>{{$value[getValueByLang('name_')]}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <input type="text" name="name_en" class="form-control" id="name_en" value="{{$detail['name_en']}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <input type="text" name="name_vi" class="form-control" id="name_vi" value="{{$detail['name_vi']}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="summernote">
                                <textarea class="form-control" name="description_en" id="description_en" >{{$detail['description_en']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="summernote">
                                <textarea class="form-control" name="description_vi" id="description_vi" >{{$detail['description_vi']}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
