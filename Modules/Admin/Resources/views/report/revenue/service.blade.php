        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    Báo cáo công nợ dịch vụ đã thu
                </h3>
            ...
            <div class="kt-subheader__toolbar">
                <a href="{{route('admin.report.export-excel-service-revenue')}}" class="btn btn-label-brand btn-bold">
                    Export excel
                </a>
            </div>
        </div>
                        ...
                        <div class="col-lg-2 col-xs-6">
                            <select name="product_id" id="product_id" class="form-control" style="width: 100%">
                                ...
                                @foreach($product as $item)
                                    <option value="{{$item['product_id']}}">{{ ($item[getValueByLang('product_name_')]) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-lg-2 col-xs-6">
...
@section('after_script')
    ...
    <script type="text/javascript"
            src="{{ asset('static/backend/js/admin/report/revenue/service.js?v='.time()) }}">
    </script>
@endsection
