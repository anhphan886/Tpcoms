                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Tỉ lệ theo loại khách hàng
                        </h3>
                    </div>
                </div>
                <div class="kt-portlet__body">
                    <div id="pie-chart-customer-type" style="height: 350px;"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div id="pie-chart-customer-status" style="height: 350px;"></div>
                </div>
            </div>
        </div>
    </div>
...
@section('after_script')
    ...
    <script type="text/javascript"
            src="{{ asset('static/backend/js/admin/report/customer.js?v='.time()) }}">
    </script>
@endsection