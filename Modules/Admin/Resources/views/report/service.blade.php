    ...
    <div class="row" id="kt-content-3">
        <div class="col-lg-4">
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div id="pie-chart-type" style="height: 350px;"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div id="pie-chart-pay" style="height: 350px;"></div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
...
@section('after_script')
    ...
    <script type="text/javascript"
            src="{{ asset('static/backend/js/admin/report/service.js?v='.time()) }}">
    </script>
@endsection