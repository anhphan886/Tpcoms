        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    @lang('ticket::issue.index.issue_create')
                </h3>
            ...
            <div class="kt-subheader__toolbar">
                <button type="button" class="btn btn-info btn-bold"  onclick="objIssue.save()">
                    @lang('ticket::issue.input.button_save_create')
                </button>
                <button type="button" class="btn btn-info btn-bold"  onclick="objIssue.save(1)">
                    @lang('ticket::issue.input.button_save_exit')
                </button>
