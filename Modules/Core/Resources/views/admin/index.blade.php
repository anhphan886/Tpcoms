                ...
                <form id="form-filter" action="{{route('core.user.index')}}">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-12 form-group">
                                <select type="text" name="admin$is_actived"
                                    ...
                                    @if(isset($filter['admin$is_actived']))
                                        <option value="1" {{($filter['admin$is_actived']=='1'?'selected':'')}}>Hoạt động
                                        </option>
                                        <option value="0" {{($filter['admin$is_actived']=='0'?'selected':'')}}>Tạm ngưng
                                        </option>
                                    @else
                            ...
                            <div class="col-lg-3 col-12 form-group nt_btn_box_right">
