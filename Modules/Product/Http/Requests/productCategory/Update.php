...
class Update extends FormRequest
{
    ...
    {
        $id = $this->input('product_category_id');
        return [
            'category_name_vi' => 'required|max:255|unique:product_categories,category_name_vi,' .$id. ',product_category_id',
            'category_name_en' => 'required|max:255|unique:product_categories,category_name_en,' .$id. ',product_category_id',
        ];
    }
