...
class StoreSegment extends FormRequest
{
    /**
    ...
    {
        return [
            'name_vi' => 'required|max:255|unique:segment,name,'.',id,is_deleted,0',
            'name_en' => 'required|max:255|unique:segment,name_en,'.',id,is_deleted,0',
        ];
    }
