...
class Update extends FormRequest
{
    ...
    public function rules()
    {
        $id = $this->input('id');
        return [
            'product_attribute_name_vi' => 'required|max:255|unique:product_attribute,product_attribute_name_vi,' . $id . ',product_attribute_id',
            'product_attribute_name_en' => 'required|max:255|unique:product_attribute,product_attribute_name_en,' . $id . ',product_attribute_id',
