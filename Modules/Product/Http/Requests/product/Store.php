...
class Store extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'product_name_vi' => 'required|max:255|unique:product,product_name_vi,' . ',product_id,is_deleted,0,is_template,0',
            'product_name_en' => 'required|max:255|unique:product,product_name_en,' . ',product_id,is_deleted,0,is_template,0',
        ];
    }
