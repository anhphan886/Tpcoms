...
class Update extends FormRequest
{
    ...
    {
        $id = $this->input('product_attribute_group_id');
        return [
            'product_attribute_group_name_vi' => 'required|max:255|unique:product_attribute_group,product_attribute_group_name_vi,' .$id. ',product_attribute_group_id',
            'product_attribute_group_name_en' => 'required|max:255|unique:product_attribute_group,product_attribute_group_name_en,' .$id. ',product_attribute_group_id',
            'positions' => 'required|unique:product_attribute_group,positions,' .$id. ',product_attribute_group_id',
        ];
    }
