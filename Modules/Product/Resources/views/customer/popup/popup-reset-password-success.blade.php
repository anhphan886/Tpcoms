            ...
            <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div class="kt-input-icon kt-input-icon--right">
                                    ...
                                    >
                                    <a href="javascript:void(0)" onclick="resetPass.show_password('#password-label')" class="kt-input-icon__icon kt-input-icon__icon--right">
                <span  class="kt-input-icon__icon kt-input-icon__icon--right">
                    <span><i class="la la-eye"></i></span>
                                ...
                                <div class="kt-input-icon kt-input-icon--right">
                                    <a href="javascript:void(0)" onclick="resetPass.copyToClipboard()"  class="col-form-label">@lang('core::user.reset-password.CLICK_TO_COPY_PASSWORD')</a>
                                </div>
                            </div>
                        </div>
                    </form>
