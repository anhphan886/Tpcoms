    ...
    <div class="table_responsive">
        <table class="table table-striped table-order">
            ...
            <tr>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.stt')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.code')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.service')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.category')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.create_by')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.create_at')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.update_by')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.update_at')
                    </p>
                </th>
                <th id="th_group_name">
                    <p class="pn-pointer">
                ...
                <th id="th_group_name">
                    <p class="pn-pointer">
                        @lang('product::product.index.action')
                    </p>
                </th>
            </tr>
            </thead>
...
{{--                            {{$filter['page']*10 + $key + 1}}--}}
                        ...
                        <td>
                            <a href="{{route('product.product.show', ['code' => $item['product_code']])}}"
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                        ...
                                        'html' => '<a href="'.route('product.product.edit', ['code' => $item['product_code']]).'" class="dropdown-item">'
