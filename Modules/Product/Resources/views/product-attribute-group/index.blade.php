    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                @lang('product::attribute-group.index.attribute_group_list')
            </h3>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid nt_content" id="kt_content">
        <div class="kt-portlet kt-portlet--tabs">
            <div class="kt-portlet__body">
                <form id="form-filter" action="{{route('product.product-attribute-group')}}">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3">
                            <a class="btn btn-secondary btn-hover-brand" href="{{route('product.product-attribute-group')}}">
                    ...
                    <div class="kt-section">
                        @include('product::product-attribute-group.list')
                    </div>
                </form>
            </div>
        </div>
