    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                @lang('product::attribute-group.index.detail')
            </h3>
                ...
                <form id="form-submit">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" type="text" value="{{$detail['product_attribute_group_name_vi']}}"
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" type="text" value="{{$detail['product_attribute_group_name_en']}}"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-form-label">
                                    @lang('product::attribute-group.create.positions')
                                </label>
                                <input disabled class="form-control col-lg-3" type="text" name="positions"
                    ...
                    <div class="row quantity_attribute" style="{{$detail['is_sold_together'] == 1 ? '' : 'display: none'}}">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                >
                                    <option value="0" {{$detail['quantity_attribute'] == '0' ? 'selected' : ''}} disabled>
                                        @lang('product::attribute-group.create.much_attribute')
                                    </option>
                                    <option value="1" {{$detail['quantity_attribute'] == '1' ? 'selected' : ''}} disabled>
