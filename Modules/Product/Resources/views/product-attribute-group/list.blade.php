            ...
            <div class="table_responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th id="th_group_name">
                            <p class="pn-pointer">
                                @lang('product::attribute-group.index.attribute_group')
                            </p>
                        </th>
                        <th id="th_group_name">
                            <p class="pn-pointer">
                    ...
                    @if (isset($list) && $list->count() > 0)
                        @foreach ($list as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('product.product-attribute-group.show', ['id' => $item['product_attribute_group_id']])}}"
                                       title="{{$item[getValueByLang('product_attribute_group_name_')] }}">
                                    ...
                                    <div class="kt-portlet__head-toolbar">
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1">
                                                ...
                                                'route' => 'product.product-attribute-group.edit',
                                                'html' => '<a href="'.route('product.product-attribute-group.edit', ['id' => $item['product_attribute_group_id']]).'" class="dropdown-item">'
                                                ...
                                                'html' => '<a href="javascript:void(0)" onclick="attributeGroup.remove('.$item['product_attribute_group_id'].')" class="dropdown-item">'
