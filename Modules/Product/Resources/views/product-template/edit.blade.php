        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    @lang('product::product-template.index.edit_view')
                </h3>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-6">
                                    <span class="kt-switch kt-switch--primary ss-float-right">
                                        <label>
                                            <input @if($product['price_by_attribute'] == 1)checked  @endif
                                                 type="checkbox" onchange="productAdd.priceByAttribute(this)"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-mask" type="text" name="price_month"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control input-mask" type="text" name="price_day"
                                        ...
                                        @foreach($productTempAttMap as $key => $value)
                                            <tr>
                                                ...
                                                <td>{{$value['product_attribute_code']}}
                                                    ...
                                                    <input type="hidden" class="input_price_day" value="{{$value['price_day']}}">
                                                ...
                                                <td>
                                                    <label class="kt-checkbox">
                                                        <input type="checkbox" class="input_no_limit"
