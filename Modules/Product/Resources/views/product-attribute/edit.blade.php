    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                @lang('product::attribute.index.edit_attribute')
            </h3>
        ...
        <div class="kt-subheader__toolbar">
            <button type="button" class="btn btn-info btn-bold" onclick="attribute.edit()">
        ...
        <div class="kt-portlet kt-portlet--tabs">
            <div class="kt-portlet__body">
                <form id="form-submit">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="unit_name" id="unit_name" class="form-control" value="{{$detail['unit_name']}}">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">
                    ...
                    <input type="hidden" id="id" name="id" value="{{$detail['product_attribute_id']}}">
                </form>
            </div>
        </div>
    </div>
