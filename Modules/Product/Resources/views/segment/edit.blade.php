    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                @lang('product::segment.index.edit_segment')
            </h3>
        ...
        <div class="kt-portlet kt-portlet--tabs">
            <div class="kt-portlet__body">
                <form id="form-submit">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input value="{{subString($detail['name'])}}" class="form-control" type="text" name="name_vi"
                                       id="name_vi">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input value="{{subString($detail['name_en'])}}" class="form-control" type="text" name="name_en"
                                       id="name_en">
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <input value="{{$detail['id']}}" class="form-control"
                           type="hidden" name="id"
                           id="id">
                </form>
            </div>
