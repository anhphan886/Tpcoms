...
@section('content')
    ...
    <div class="kt-subheader kt-grid__item" id="kt_subheader">
        ...
        <div class="kt-subheader__toolbar">
            @if(isset($param['invoice_no']) && $param['invoice_no'] != null)
                <button type="button" class="btn btn-info btn-bold" onclick="receipt.save2()">
                    @lang('product::customer.receipt.receipt_action')
                </button>
            @else
                <button type="button" class="btn btn-info btn-bold" onclick="receipt.save()">
                    @lang('product::customer.receipt.receipt_action')
                </button>
            @endif
