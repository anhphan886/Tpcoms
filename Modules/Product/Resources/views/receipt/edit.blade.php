...
@section('content')
    ...
    <form id="form-edit-receipt" method="POST">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    @lang('product::customer.receipt.edit')
                </h3>
            ...
            <div class="kt-subheader__toolbar">
                <button type="button" class="btn btn-info btn-bold" onclick="receipt.submitButton()">
                    @lang('product::customer.receipt.save')
                </button>
                <a href="{{route('product.receipt')}}" class="btn btn-secondary btn-bold">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" type="hidden" name="receipt_id"
                                            id="receipt_id" value="{{$receipt['receipt_id']}}">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label">
                                ...
                                <div class="form-group">
                                    <label class="col-form-label"> @lang('product::customer.receipt.pay_expired')</label>
                                        <div class="input-group date">
                                            <input type="text" class="form-control"  readonly name="pay_expired" id="kt_datepicker_2"
                                                   value="{{date('d/m/Y ', strtotime($receipt['pay_expired'])) }} "/>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input class="form-control" disabled type="text" name="product_name_en"
                                                   value="{{(new DateTime($receipt['created_at']))->format('d/m/Y')}}"
                                                   id="product_name_en">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input class="form-control" disabled type="text" name="product_name_en"
                                                   value="{{(new DateTime($receipt['modified_at']))->format('d/m/Y')}}"
                                                   id="product_name_en">
                                        </div>
                                    </div>
                                </div>
